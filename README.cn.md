...
[![x-cmd/install — velad Code Quality Monitoring Repo Card](https://repo.x-cmd.io/velad.svg?lang=zh)](https://x-cmd.com/install/velad)
...
合计: **3,281** 行代码（覆盖前 5 种语言、共 **40** 个文件）。
...
- **上游仓库**: <https://github.com/kubevela/velad>
- **许可证**: Apache-2.0
...
- **Star**: 74 · **Fork**: 17 · **开放 issue**: 43 · **贡献者**: 36

## 累计统计

- **发布数**: 54 · **已合并 PR**: 104 · **开放 PR**: 5 · **已关闭 issue**: 20 · **开放 issue**: 23 · **提交数**: 232
...
| last60d | 2026-07-24 | 0 | 3 | 0 | 0 | 0 | 3 |
| 90d | 2026-06-24 | 0 | 3 | 0 | 0 | 0 | 3 |
| last180d | 2026-03-26 | 0 | 3 | 0 | 0 | 0 | 3 |
| 360d | 2025-09-27 | 0 | 3 | 0 | 0 | 0 | 3 |
| last720d | 2024-10-02 | 0 | 4 | 1 | 1 | 1 | 4 |
...
velad 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `velad` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/velad.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260922.yml` · 2026-09-22T05:48:44Z._
